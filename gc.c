/**********************************************************************
  ...
  Copyright (c) 2007 Object Media Limited
	Addition of a memory tracking API to Ruby.
	See memtrack.c/memtrack.h for details and warranty.
	The modifications are:
		additional calls to _mem_track_track_allocate() and _mem_track_track_deallocate() to track memory usage.
		new functions
							 ...
							 void				*userData)
{
	...
	st_foreach(tbl, _gc_getReferencedHashTableIterator, (VALUE)&callback);
}
